...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${staticPath}/css/font-awesome.min.css" />

    <!-- CSS | animate -->
    <link  rel="stylesheet" type="text/css" href="${staticPath}/css/bootstrap.min.css" />

    <!-- Credits: http://daneden.github.io/animate.css/ -->
    <link rel="stylesheet" type="text/css" href="${staticPath}/css/animate.min.css" />

    <!-- CSS | Normalize -->
    <!-- Credits: http://manos.malihu.gr/jquery-custom-content-scroller -->
    <link rel="stylesheet" type="text/css" href="${staticPath}/css/jquery.mCustomScrollbar.css" />

    <!-- CSS | Colors -->
    <link rel="stylesheet" type="text/css" href="${staticPath}/css/colors/DarkBlue.css" id="colors-style" />
    <link rel="stylesheet" type="text/css" href="${staticPath}/css/switcher.css" />
    ...
    <link rel="stylesheet" type="text/css" href="${staticPath}/css/prettyPhoto.css"/>

    <!-- CSS | Google Fonts -->
    <link href='http://fonts.useso.com/css?family=Lato:300,400' rel='stylesheet' type='text/css'>
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="${staticPath}/images/favicon/favicon.ico">

    <!--[if IE 7]>
    <link rel="stylesheet" type="text/css" href="${staticPath}/css/icons/font-awesome-ie7.min.css"/>
    <![endif]-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-3 col-xs-12 ">
                                    ...
                                    <div class="image-holder one" id="pic_prof_1" style="display:block">
                                        ...
                                        <img class="head-image up circle" src="${staticPath}/images/img/up.png" width="150" height="150" alt="" />
                                        <img class="head-image up-left circle" src="${staticPath}/images/img/upleft.png" width="150" height="150" alt="" />
                                        <img class="head-image left circle" src="${staticPath}/images/img/left.png" width="150" height="150" alt="" />
                                        <img class="head-image down-left circle" src="${staticPath}/images/img/downleft.png" width="150" height="150" alt="" />
                                        <img class="head-image down circle" src="${staticPath}/images/img/down.png" width="150" height="150" alt="" />
                                        <img class="head-image down-right circle" src="${staticPath}/images/img/downright.png" width="150" height="150" alt="" />
                                        <img class="head-image right circle" src="${staticPath}/images/img/right.png" width="150" height="150" alt="" />
                                        <img class="head-image up-right circle" src="${staticPath}/images/img/upright.png" width="150" height="150" alt="" />
                                        <img class="head-image front circle" src="${staticPath}/images/img/front.png" width="150" height="150" alt="" />
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-9 col-xs-12">
                                    ...
                                    <div id="profile_desc">
                                        ...
                                        <p>
                                            More Templates <a href="http://www.17sucai.com/" target="_blank" title="17素材网">17素材网</a> - Collect from <a href="${staticPath}/http://www.17sucai.com/" title="网页模板" target="_blank">网页模板</a>
                                        </p>
                                    </div>
                                    ...
                                    <div id="profile_social">
                                        ...
                                        <a href="${staticPath}/#"><i class="fa fa-facebook"></i></a>
                                        <a href="${staticPath}/#"><i class="fa fa-twitter"></i></a>
                                        <a href="${staticPath}/#"><i class="fa fa-linkedin"></i></a>
                                        <a href="${staticPath}/#"><i class="fa fa fa-dribbble"></i></a>
                                        <a href="${staticPath}/#"><i class="fa fa-foursquare"></i></a>
                                        <div class="clear"></div>
                                    </div>
                                    <!-- End Name -->
                        ...
                        <div class="col-md-9 flexy_content" style="padding-left: 0;padding-right: 0;">
                            ...
                            <div id="verticalTab">
                                ...
                                <ul class="resp-tabs-list">
                                    ...
                                    <a href="${staticPath}/#" id="print"><i class="fa fa-print icon_print"></i> </a>
                                    <a href="${staticPath}/#" id="downlowd"><i class="fa fa-download icon_print"></i> </a>
                                </ul>
                                <!-- /resp-tabs-list -->
                                ...
                                <div class="resp-tabs-container">
                                    ...
                                    <div id="profile" class="content_2">
                                            ...
                                            <div class="col-md-6 profile-l">
                                                ...
                                                <ul class="about">
                                                    ...
                                                    <li>
                                                        ...
                                                        <label>Website</label>
                                                        <span class="value"><a href="${staticPath}/#" target="_blank">sc.chinaz.com</a></span>
                                                        <div class="clear"></div>
                                                    </li>
                                        ...
                                        <div class="copyrights">Collect from <a href="${staticPath}/http://www.17sucai.com/" >免费模板</a></div>
                                                ...
                                                <div class="bottom-p">
                                                    ...
                                                    <div class="panel-group" id="accordion">
                                                        <div class="panel panel-default">
                                                            <div class="panel-heading">
                                                                <h4 class="panel-title">
                                                                    <a data-toggle="collapse" data-parent="#accordion" href="${staticPath}/#collapseOne" class="collapse_tabs">
                                                                        Making Money
                                                        ...
                                                        <div class="panel panel-default">
                                                            <div class="panel-heading">
                                                                <h4 class="panel-title">
                                                                    <a data-toggle="collapse" data-parent="#accordion" href="${staticPath}/#collapseTwo" class="collapse_tabs">
                                                                        Easy to Customize
                                                        ...
                                                        <div class="panel panel-default">
                                                            <div class="panel-heading">
                                                                <h4 class="panel-title">
                                                                    <a data-toggle="collapse" data-parent="#accordion" href="${staticPath}/#collapseThree" class="collapse_tabs">
                                                                        Moving Let Us Help
                                                                        <i class="glyphicon glyphicon-chevron-down" style="float: right;font-size: 13px;"></i>
                                                                    </a>
                                                                </h4>
                                    ...
                                    <div id="resume" class="content_2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <!-- .download_resume -->
                                                <a class="download" style="margin:0;float: left;" href="${staticPath}/#">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="reference clearfix">
                                                    ...
                                                    <ul>
                                                        <li class="clearfix">
                                                            <img src="${staticPath}/http://placehold.it/100x100" class="img_reference" width="100" height="100" alt="">
                                            ...
                                            <div id="portfoliolist">
                                                ...
                                                <div class="portfolio logo" data-cat="logo">
                                                    ...
                                                    <div class="portfolio-wrapper">
                                                        <a href="${staticPath}/images/portfolio/1.jpg" rel="portfolio" title="Lorem ipsum dolor sit amet, consectetur adipiscing Vivamus sit amet ligula non lectus.consectetur adipiscingVivamus sit amet">
                                                ...
                                                <div class="portfolio catWeb" data-cat="catWeb">
                                                    <!-- .portfolio-wrapper -->
                                                    <div class="portfolio-wrapper">
                                                        <a href="${staticPath}/http://www.youtube.com/watch?v=c9MnSeYYtYY" rel="portfolio">
                                                ...
                                                <div class="portfolio catWeb" data-cat="catWeb">
                                                    <!-- .portfolio-wrapper -->
                                                    <div class="portfolio-wrapper">
                                                        <a href="${staticPath}/images/portfolio/3.jpg" rel="portfolio">
                                                ...
                                                <div class="portfolio catMotion" data-cat="catMotion">
                                                    <!-- .portfolio-wrapper -->
                                                    <div class="portfolio-wrapper">
                                                        <a href="${staticPath}/images/portfolio/4.jpg" rel="portfolio">
                                                ...
                                                <div class="portfolio catWeb" data-cat="catWeb">
                                                    <!-- .portfolio-wrapper -->
                                                    <div class="portfolio-wrapper">
                                                        <a href="${staticPath}/images/portfolio/5.jpg" title="Etiam quis mi eu elit tempor facilisis id et neque. Nulla sit amet sem sapien." rel="portfolio">
                                                ...
                                                <div class="portfolio catMotion" data-cat="catMotion">
                                                    <!-- .portfolio-wrapper -->
                                                    <div class="portfolio-wrapper">
                                                        <a href="${staticPath}/images/portfolio/6.jpg" rel="portfolio">
                                                ...
                                                <div class="portfolio catGraphic" data-cat="catGraphic">
                                                    <!-- .portfolio-wrapper -->
                                                    <div class="portfolio-wrapper">
                                                        <a href="${staticPath}/images/portfolio/7.jpg" title="Etiam quis mi eu elit tempor facilisis id et neque. Nulla sit amet sem sapien." rel="portfolio">
                                                ...
                                                <div class="portfolio logo" data-cat="logo">
                                                    <!-- .portfolio-wrapper -->
                                                    <div class="portfolio-wrapper">
                                                        <a href="${staticPath}/images/portfolio/8.jpg" rel="portfolio" title="Etiam quis mi eu elit tempor facilisis id et neque. Nulla sit amet sem sapien.">
                                                ...
                                                <div class="portfolio catWeb" data-cat="catWeb">
                                                    <!-- .portfolio-wrapper -->
                                                    <div class="portfolio-wrapper">
                                                        <a href="${staticPath}/images/portfolio/9.jpg" title="Etiam quis mi eu elit tempor facilisis id et neque. Nulla sit amet sem sapien." rel="portfolio">
                                                ...
                                                <div class="portfolio catGraphic" data-cat="catGraphic">
                                                    <!-- .portfolio-wrapper -->
                                                    <div class="portfolio-wrapper">
                                                        <a href="${staticPath}/images/portfolio/10.jpg" rel="portfolio">
                                                ...
                                                <div class="portfolio logo" data-cat="logo">
                                                    <!-- .portfolio-wrapper -->
                                                    <div class="portfolio-wrapper">
                                                        <a href="${staticPath}/images/portfolio/11.jpg" title="Etiam quis mi eu elit tempor facilisis id et neque. Nulla sit amet sem sapien." rel="portfolio">
                                                ...
                                                <div class="portfolio logo" data-cat="logo">
                                                    <!-- .portfolio-wrapper -->
                                                    <div class="portfolio-wrapper">
                                                        <a href="${staticPath}/images/portfolio/12.jpg" rel="portfolio">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-12 post_media">
                                                                        <div class="post-format-icon">
                                                                            <a href="${staticPath}/#" class="item-date"><span class="fa fa-picture-o"></span></a>
                                                                        </div>
                                                                        <div class="media">
                                                                                ...
                                                                                <div id="carousel-1" class="carousel slide" data-ride="carousel">
                                                                                    ...
                                                                                    <div class="carousel-inner">
                                                                                        ...
                                                                                        <div class="item active">
                                                                                            <img src="${staticPath}/images/blog/blog-1.jpg" alt="" />
                                                                                        ...
                                                                                        <div class="item">
                                                                                            <img src="${staticPath}/images/blog/blog-2.jpg" alt="" />
                                                                                            <div class="carousel-caption">
                                                                                                <h4>First Thumbnail label</h4>
                                                                                                <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
                                                                                            </div>
                                                                                        ...
                                                                                        <div class="item">
                                                                                            <img src="${staticPath}/images/blog/blog-3.jpg" alt="" />
                                                                                            <div class="carousel-caption">
                                                                                                <h4>First Thumbnail label</h4>
                                                                                                <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
                                                                                            </div>
                                                                                    ...
                                                                                    <a class="left carousel-control" href="${staticPath}/#carousel-1" data-slide="prev">
                                                                                        <span class="glyphicon glyphicon-chevron-left"></span>
                                                                                    </a>

                                                                                    <a class="right carousel-control" href="${staticPath}/#carousel-1" data-slide="next">
                                                                    ...
                                                                    <div class="col-md-12 post_content">
                                                                        <div class="content post_format_standart">
                                                                            <div class="top_c ">
                                                                                ...
                                                                                <div class="title_content">
                                                                                    <div class="text_content"><a href="${staticPath}/#post-1" class="read_more">Blog Post Gallery</a></div>
                                                                                    <div class="clear"></div>
                                                                                </div>
                                                                        ...
                                                                        <a href="${staticPath}/#post-1" class="read_m pull-right">Read More <i class='glyphicon glyphicon-chevron-right'></i></a>
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-12 post_media">
                                                                        ...
                                                                        <div class="post-format-icon">
                                                                            <a href="${staticPath}/#" class="item-date"><span class="fa fa-pencil"></span></a>
                                                                        </div>
                                                                    ...
                                                                    <div class="col-md-12 post_content">
                                                                        <div class="content post_format_standart">
                                                                            <div class="top_c ">
                                                                                ...
                                                                                <div class="title_content">
                                                                                    <div class="text_content"><a href="${staticPath}/#post-2" class="read_more">Blog Aside post</a></div>
                                                                                    <div class="clear"></div>
                                                                                </div>
                                                                        ...
                                                                        <a href="${staticPath}/#post-2" class="read_m pull-right">Read More <i class='glyphicon glyphicon-chevron-right'></i></a>
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-12 post_media">
                                                                        ...
                                                                        <div class="media">
                                                                            <div class="he-wrap tpl2">
                                                                                <img src="${staticPath}/images/blog/blog-4.jpg" class="img-hover" alt="" />
                                                                            </div>
                                                                    ...
                                                                    <div class="col-md-12 post_content">
                                                                        <div class="content post_format_standart">
                                                                            <div class="top_c ">
                                                                                ...
                                                                                <div class="title_content">
                                                                                    <div class="text_content"><a href="${staticPath}/#post-3" class="read_more">Blog Post Image</a></div>
                                                                                    <div class="clear"></div>
                                                                                </div>
                                                                        ...
                                                                        <a href="${staticPath}/#post-3" class="read_m pull-right">Read More <i class='glyphicon glyphicon-chevron-right'></i></a>
                                                                ...
                                                                <article class="postPage">
                                                                    ...
                                                                    <div class="col-md-12 first">
                                                                        ...
                                                                        <div class="post_comments">
                                                                            ...
                                                                            <div class="comments">
                                                                                ...
                                                                                <div class="comment">
                                                                                    <img src="${staticPath}/http://placehold.it/100x100" width="100" height="100" alt="img" />
                                                                                    <div class="text">
                                                                                        <div class="name">John Doe <a class="reply" href="${staticPath}/#">Reply</a></div>
                                                                                    ...
                                                                                    <div class="comment sub">
                                                                                        <img src="${staticPath}/http://placehold.it/100x100" width="100" height="100" alt="img" />
                                                                                        <div class="text">
                                                                                            <div class="name">Bill Gates <a class="reply" href="${staticPath}/#">Reply</a></div>
                                                                                            <div class="date">12, September, 2013</div>
                                                                                            Lorem ipsum dolor sit amet, consectetur
                                                                                            adipiscing elit. Praesent condimentum sed elit
                                                                                            vitae tristique. Aliquam erat volutpat. Nunc sit
                                                                                ...
                                                                                <div class="comment">
                                                                                    <img src="${staticPath}/http://placehold.it/100x100" width="100" height="100" alt="img" />
                                                                                    <div class="text">
                                                                                        <div class="name">John Smith <a class="reply" href="${staticPath}/#">Reply</a></div>
                                                                                        <div class="date">12, September, 2013</div>
                                                                                        Lorem ipsum dolor sit amet, consectetur
                                                                                        adipiscing elit. Praesent condimentum sed elit
                                                                                        vitae tristique. Aliquam erat volutpat. Nunc sit
                                                                                ...
                                                                                <div class="comment">
                                                                                    <img src="${staticPath}/http://placehold.it/100x100" width="100" height="100" alt="img" />
                                                                                    <div class="text">
                                                                                        <div class="name">Andrian Robert <a class="reply" href="${staticPath}/#">Reply</a></div>
                                                                                        <div class="date">12, September, 2013</div>
                                                                                        Lorem ipsum dolor sit amet, consectetur
                                                                                        adipiscing elit. Praesent condimentum sed elit
                                                                                        vitae tristique. Aliquam erat volutpat. Nunc sit
                                                                        ...
                                                                        <div class="col-md-12" style="margin-top: 20px;">
                                                                            <a href="${staticPath}/#post-2" class="readmore" id="pagination"><i class="glyphicon glyphicon-chevron-right"></i></a>
                                                                            <a href="${staticPath}/#" class="readmore disabled" id="pagination"><i class="glyphicon glyphicon-chevron-left"></i></a>
                                                                            <a href="${staticPath}/#blog" class="readmore"><i class="glyphicon glyphicon-chevron-left"></i> All Posts</a>
                                                                        </div>
                                                            ...
                                                            <div class="col-md-12" style="width: 100%;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;float: left;background: rgba(255, 255, 255, 0.8);padding-bottom: 15px;padding-top: 15px;">
                                                                ...
                                                                <article class="postPage">
                                                                    ...
                                                                    <div class="col-md-12 first">
                                                                        ...
                                                                        <div class="col-md-12"  style="margin-top: 20px;">
                                                                            <a href="${staticPath}/#post-3" class="readmore" id="pagination"><i class="glyphicon glyphicon-chevron-right"></i></a>
                                                                            <a href="${staticPath}/#post-1" class="readmore" id="pagination"><i class="glyphicon glyphicon-chevron-left"></i></a>
                                                                            <a href="${staticPath}/#blog" class="readmore"><i class="glyphicon glyphicon-chevron-left"></i> All Posts</a>
                                                                        </div>
                                                            ...
                                                            <div class="col-md-12" style="width: 100%;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;float: left;background: rgba(255, 255, 255, 0.8);padding-bottom: 15px;padding-top: 15px;">
                                                                ...
                                                                <article class="postPage">
                                                                    ...
                                                                    <div class="col-md-12 post_media">
                                                                        ...
                                                                        <div class="media">
                                                                            <div class="he-wrap tpl2">
                                                                                <img src="${staticPath}/images/blog/blog-2.jpg" class="img-hover" alt="">
                                                                            </div>
                                                                    ...
                                                                    <div class="col-md-12 first">
                                                                        ...
                                                                        <div class="col-md-12" style="margin-top: 20px;">
                                                                            <a href="${staticPath}/#" class="readmore disabled" id="pagination"><i class="glyphicon glyphicon-chevron-right"></i></a>
                                                                            <a href="${staticPath}/#post-2" class="readmore" id="pagination"><i class="glyphicon glyphicon-chevron-left"></i></a>
                                                                            <a href="${staticPath}/#blog" id="blog" class="readmore"><i class="glyphicon glyphicon-chevron-left"></i> All Posts</a>
                                                                        </div>
...
<div id="custumize-style">
    <h2>Style Selector<a href="${staticPath}/#" class="switcher"><i class="fa fa-cogs icon-switcher"></i></a></h2>
    <div>
        <h3>Theme Color</h3>
        <ul class="colors-style" id="color1">

            <li><a href="${staticPath}/#" class="gray"></a></li>
            <li><a href="${staticPath}/#" class="green"></a></li>
            <li><a href="${staticPath}/#" class="blue"></a></li>
            <li><a href="${staticPath}/#" class="red"></a></li>
            <li><a href="${staticPath}/#" class="yellow"></a></li>

            <li><a href="${staticPath}/#" class="DarkBlue"></a></li>
            <li><a href="${staticPath}/#" class="orange"></a></li>
            <li><a href="${staticPath}/#" class="rose"></a></li>
            <li><a href="${staticPath}/#" class="lightseagreen"></a></li>
            <li><a href="${staticPath}/#" class="darkolivegreen"></a></li>
    ...
    <div>
        ...
        <ul class="colors-style bgsolid" id="bgsolid">
            <li><a href="${staticPath}/#" class="gray-bg"></a></li>
            <li><a href="${staticPath}/#" class="green-bg"></a></li>
            <li><a href="${staticPath}/#" class="blue-bg"></a></li>
            <li><a href="${staticPath}/#" class="red-bg"></a></li>
            <li><a href="${staticPath}/#" class="yellow-bg"></a></li>
        </ul>
    </div>
    ...
    <div>
        ...
        <ul class="colors-style bg" id="bg">
            <li><a href="${staticPath}/#" class="bg1"></a></li>
            <li><a href="${staticPath}/#" class="bg2"></a></li>
            <li><a href="${staticPath}/#" class="bg3"></a></li>
            <li><a href="${staticPath}/#" class="bg4"></a></li>
            <li><a href="${staticPath}/#" class="bg5"></a></li>
        </ul>
    </div>

    <div id="button-reset"><a href="${staticPath}/#" class="button color blue boxed">Reset</a></div>
</div>
<!-- End Switcher -->
...
<script type="text/javascript" src="${staticPath}/js/jquery.cycle2.min.js"></script>

<!-- jquery | rotate and portfolio -->
<!-- Credits: http://jquery.com -->
<script type="text/javascript" src="${staticPath}/js/jquery.mixitup.min.js"></script>
<script type="text/javascript" src="${staticPath}/js/HeadImage.js"></script>

<!-- Js | easyResponsiveTabs -->
<!-- Credits: http://webtrendset.com/demo/easy-responsive-tabs/Index.html -->
<script type="text/javascript" src="${staticPath}/js/easyResponsiveTabs.min.js"></script>

<!-- Js | jquery.cookie -->
<!-- Credits: https://github.com/carhartl/jquery-cookie -->
<script type="text/javascript" src="${staticPath}/js/jsSwitcher/jquery.cookie.js"></script>

<!-- Js | switcher -->
<!-- Credits: http://themeforest.net/user/FlexyCodes -->
<script type="text/javascript" src="${staticPath}/js/jsSwitcher/switcher.js"></script>

<!-- Js | mCustomScrollbar -->
<!-- Credits: http://manos.malihu.gr/jquery-custom-content-scroller -->
<script type="text/javascript" src="${staticPath}/js/jquery.mCustomScrollbar.concat.min.js"></script>

<!-- jquery | prettyPhoto -->
<!-- Credits: http://www.no-margin-for-errors.com/ -->
<script type="text/javascript" src="${staticPath}/js/jquery.prettyPhoto.js"></script>

<!-- Js | gmaps -->
<!-- Credits: http://maps.google.com/maps/api/js?sensor=true-->

<script type="text/javascript" src="${staticPath}/js/gmaps.min.js"></script>
